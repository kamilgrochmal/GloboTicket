    ...
    public class GloboTicketDbContext: DbContext
        {
            ...
            {
                modelBuilder.ApplyConfigurationsFromAssembly(typeof(GloboTicketDbContext).Assembly); // This command search in assembly for configurations and apply them on the modelBuilder. We have one with Event
            ...
            // overridden SaveChangesAsync to Track the DateTime of when sb add new entity or modify new entity
